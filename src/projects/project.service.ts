...
export class ProjectService {
  ...
  async create (uid:string): Promise<any> {
    ...
    VALUES(16, 'Default', 'Grupo por defecto del sistema', '["Default"]', 'System', 'brayan@onbotgo.com', '2022-05-23 22:59:23.541', '2022-07-07 22:26:39.000', 1, true);
    `)
    await this.dataSource.query(`INSERT INTO ${schema}."role" ("name",description,config,created_by,updated_by,created_at,updated_at,status,"default") values
    ('Agente','Usuario para gestión operativa de conversaciones','[{"name": "settings", "tabs": [], "hasTabs": true, "childrens": [], "displayName": "Configuración", "permissions": [], "hasChildrens": false, "hasPermissions": false, "permissionsToDisplay": []}, {"name": "conversation", "tabs": [], "hasTabs": false, "childrens": [], "displayName": "Conversaciones", "permissions": ["create", "read", "update", "delete"], "hasChildrens": false, "hasPermissions": true, "permissionsToDisplay": ["Crear", "Leer", "Actualizar", "Eliminar"]}]','Fernando','brayan@onbotgo.com','2022-05-23 15:59:33.709','2022-07-07 22:27:32.000',1,false),
        ('Root','Usuario administrador de todos los recursos','[{"name": "conversation", "tabs": [], "hasTabs": false, "childrens": [], "displayName": "Conversaciones", "permissions": ["create", "read", "update", "delete"], "hasChildrens": false, "hasPermissions": true, "permissionsToDisplay": ["Crear", "Leer", "Actualizar", "Eliminar"]}, {"name": "settings", "tabs": [{"name": "user", "displayName": "Usuarios", "permissions": ["create", "read", "update", "delete"], "hasPermissions": true, "permissionsToDisplay": ["Crear", "Leer", "Actualizar", "Eliminar"]}, {"name": "group", "displayName": "Grupos", "permissions": ["create", "read", "update", "delete"], "hasPermissions": true, "permissionsToDisplay": ["Crear", "Leer", "Actualizar", "Eliminar"]}, {"name": "channel", "displayName": "Canales", "permissions": ["create", "read", "update", "delete"], "hasPermissions": true, "permissionsToDisplay": ["Crear", "Leer", "Actualizar", "Eliminar"]}, {"name": "role", "displayName": "Roles", "permissions": ["create", "read", "update", "delete"], "hasPermissions": true, "permissionsToDisplay": ["Crear", "Leer", "Actualizar", "Eliminar"]}], "hasTabs": true, "childrens": [], "displayName": "Configuración", "permissions": [], "hasChildrens": false, "hasPermissions": false, "permissionsToDisplay": []}]','brayan@onbotgo.com','','2022-07-07 22:22:33.000','2022-07-07 22:22:33.000',1,true),
         ('Supervisor','Usuario con permisos de asignar conversaciones y supervisar los procesos','[{"name": "conversation", "tabs": [], "hasTabs": false, "childrens": [], "displayName": "Conversaciones", "permissions": ["create", "read", "update"], "hasChildrens": false, "hasPermissions": true, "permissionsToDisplay": ["Crear", "Leer", "Actualizar", "Eliminar"]}, {"name": "settings", "tabs": [{"name": "user", "displayName": "Usuarios", "permissions": ["create", "read", "update"], "hasPermissions": true, "permissionsToDisplay": ["Crear", "Leer", "Actualizar", "Eliminar"]}, {"name": "group", "displayName": "Grupos", "permissions": ["create", "read", "update"], "hasPermissions": true, "permissionsToDisplay": ["Crear", "Leer", "Actualizar", "Eliminar"]}, {"name": "channel", "displayName": "Canales", "permissions": ["create", "read", "update"], "hasPermissions": true, "permissionsToDisplay": ["Crear", "Leer", "Actualizar", "Eliminar"]}, {"name": "role", "displayName": "Roles", "permissions": ["read"], "hasPermissions": true, "permissionsToDisplay": ["Crear", "Leer", "Actualizar", "Eliminar"]}], "hasTabs": true, "childrens": [], "displayName": "Configuración", "permissions": [], "hasChildrens": false, "hasPermissions": false, "permissionsToDisplay": []}]','Fernando','brayan@onbotgo.com','2022-05-23 15:59:22.483','2022-07-07 22:24:13.000',1,false),
