...
export class ProjectService {
  ...
  async create (uid:string): Promise<any> {
    ...
    VALUES(1, 'Default', 'Grupo por defecto del sistema', '["Default"]', 'System', 'brayan@onbotgo.com', '2022-05-23 22:59:23.541', '2022-07-07 22:26:39.000', 1, true);
    `)
    await this.dataSource.query(`INSERT INTO ${schema}."role" (id,"name",description,config,created_by,updated_by,created_at,updated_at,status,"default") values
