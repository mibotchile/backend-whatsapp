...
export class ProjectService {
  ...
  async create (uid:string): Promise<any> {
    ...
    ("name", description, tags, created_by, updated_by, created_at, updated_at, status, "default")
    VALUES( 'Default', 'Grupo por defecto del sistema', '["Default"]', 'System', 'system', '${now}', '${now}', 1, true);
    `)
    await this.dataSource.query(`
    INSERT INTO ${schema}."role" ("name",description,config,created_by,updated_by,created_at,updated_at,status,"default") values
